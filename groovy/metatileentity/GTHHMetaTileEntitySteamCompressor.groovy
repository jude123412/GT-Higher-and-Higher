...
class GTHHMetaTileEntitySteamCompressor extends RecipeMapSteamMultiblockController {

    private static final int PARALLEL_LIMIT = 8

    GTHHMetaTileEntitySteamCompressor(ResourceLocation metaTileEntityId) {
    ...
    MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new GTHHMetaTileEntitySteamCompressor(metaTileEntityId)
    }
