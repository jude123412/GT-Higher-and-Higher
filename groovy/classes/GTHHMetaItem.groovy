...
class GTHHMetaItem {
    ...
    static void registerMetaItem2() {
        StandardMetaItem metaItem2 = new StandardMetaItem((short) 0)
            ...
            metaItem2.addItem(getMetaItemId(), "circuit.slimeware_computer")
            ...
            metaItem2.addItem(getMetaItemId(), "circuit.lasertronic_computer")
            ...
            metaItem2.addItem(getMetaItemId(), "circuit.bohemian_computer")
